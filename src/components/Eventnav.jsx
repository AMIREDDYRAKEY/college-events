  ...
  return (
    <div className="min-h-screen  pb-[50px]  lg:pt-[100px] pt-[60px] flex flex-col items-center justify-center  bg-[#12122d]">
      ...
      <div className='  pt-[50px] gap-4'>
        <h1 class="text-4xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-400 animate-gradient-x text-center font-bold">
  Tech Explore Events
</h1>
