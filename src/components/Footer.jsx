...
import img from '../assets/scanme.png';

const Footer = () => {
  return (
    <div className='mt-[60px] flex items-center justify-center'>
      <div className='shadow-xl backdrop-blur-md lg:gap-0 gap-5 lg:p-0 p-3 lg:w-[95%] lg:ml-[30px] ml-[35px] bg-white/10 lg:flex lg:flex-row flex flex-col rounded-2xl justify-between lg:items-center lg:h-[300px] px-[50px] mx-[50px] lg:px-[70px]'>
