  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0b132b] via-[#2a1b3d] to-[#3a506b]">
      <div className="flex items-center justify-center">
        <div className="md:w-[330px] md:h-[420px] w-[300px] mt-[120px] rounded-lg shadow-lg shadow-[#4b3c63] overflow-y-auto no-scrollbar bg-[#34244c]">
          <div className="flex flex-col gap-7 pb-[20px] items-center justify-center ">
            ...
            <div className="flex flex-col gap-4 items-center justify-center ">
              <span className='flex flex-col'> <input type="text" placeholder="Username" value={username} className="w-[260px] rounded-xl py-[8px] p-3 bg-[#34244c] border-[1px] text-gray-400" onChange={(e) => setusername(e.target.value)} />
                {errors.username && <span className='text-red-600 ml-[10px]'>{errors.username}</span>}
              </span>
              <span className='flex flex-col'> <input type="Email" placeholder="Email" value={Email} className="w-[260px] rounded-xl py-[8px] p-3 bg-[#34244c] border-[1px] text-gray-400" onChange={(e) => setEmail(e.target.value)} />
                {errors.Email && <span className='text-red-600 ml-[10px]'>{errors.Email}</span>}
              </span>
              <span className='flex flex-col'> <input type="Password" placeholder="Password" value={password} className="w-[260px] rounded-xl py-[8px] p-3 bg-[#34244c] border-[1px] text-gray-400" onChange={(e) => setpassword(e.target.value)} />
                {errors.password && <span className='text-red-600 ml-[10px]'>{errors.password}</span>}
              </span>
              <span className='flex flex-col'> <input type="text" placeholder="Id No" value={Idno} className="w-[260px] rounded-xl py-[8px] p-3 bg-[#34244c] border-[1px] text-gray-400" onChange={(e) => setIdno(e.target.value)} />
